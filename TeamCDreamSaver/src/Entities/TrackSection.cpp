...
TrackSection::TrackSection(std::vector<std::shared_ptr<ObjectMesh>> mesh, vec3 position, glm::mat4 rotation)
	:PhysicsObject(position, glm::quat_cast(rotation), vec3(0)),
	IRenderable(false)
{
