...
//Name: L - Zig zag.ma
//Last modified: Sun, Feb 17, 2013 06:36:37 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -9.4334407249979222 217.44064027934337 297.9241766818003 ;
	setAttr ".r" -type "double3" 324.59999999941334 -360.79999999978668 359.9999999999863 ;
	setAttr ".rpt" -type "double3" -2.0659546574602889e-16 2.4139211040358891e-16 -5.4082360853217817e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 371.90405331462034;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.12499999999999994 0.5 -5.1700245069455661 ;
...
createNode transform -n "group1";
	setAttr ".t" -type "double3" 2 0.25 -3 ;
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0 -0.25 -3 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" -8 -0.25 -5 ;
...
createNode mesh -n "pCubeShape2" -p "transform8";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".vt[0:7]"  -2 -0.25 3 2 -0.25 3 -2 0.25 3 2 0.25 3 -2 0.25 -3
		 2 0.25 -3 -2 -0.25 -3 2 -0.25 -3;
...
createNode transform -n "pCube3";
	setAttr ".t" -type "double3" -4 -0.25 -4 ;
...
createNode transform -n "pCube4";
	setAttr ".t" -type "double3" 1.875 0.25 -3 ;
...
createNode transform -n "pCube5";
	setAttr ".t" -type "double3" -9.875 0.25 -5 ;
...
createNode transform -n "pCube6";
	setAttr ".t" -type "double3" -1.875 0.25 -1.125 ;
...
createNode transform -n "pCube7";
	setAttr ".t" -type "double3" -6.125 0.25 -6.875 ;
...
createNode mesh -n "pCubeShape7" -p "transform3";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".vt[0:7]"  -0.125 -0.25 1.125 0.125 -0.25 1.125 -0.125 0.25 1.125
		 0.125 0.25 1.125 -0.125 0.25 -1.125 0.125 0.25 -1.125 -0.125 -0.25 -1.125 0.125 -0.25 -1.125;
	setAttr -s 12 ".ed[0:11]"  0 1 0 2 3 0 4 5 0 6 7 0 0 2 0 1 3 0 2 4 0
		 3 5 0 4 6 0 5 7 0 6 0 0 7 1 0;
	setAttr -s 6 -ch 24 ".fc[0:5]" -type "polyFaces" 
		f 4 0 5 -2 -5
...
createNode transform -n "pCube8";
	setAttr ".t" -type "double3" -5.875 0.25 -2.125 ;
...
createNode transform -n "pCube9";
	setAttr ".t" -type "double3" -2.125 0.25 -5.875 ;
...
createNode mesh -n "pCubeShape9" -p "transform1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".vt[0:7]"  -4.125 -0.25 0.125 4.125 -0.25 0.125 -4.125 0.25 0.125
		 4.125 0.25 0.125 -4.125 0.25 -0.125 4.125 0.25 -0.125 -4.125 -0.25 -0.125 4.125 -0.25 -0.125;
	setAttr -s 12 ".ed[0:11]"  0 1 0 2 3 0 4 5 0 6 7 0 0 2 0 1 3 0 2 4 0
		 3 5 0 4 6 0 5 7 0 6 0 0 7 1 0;
	setAttr -s 6 -ch 24 ".fc[0:5]" -type "polyFaces" 
		f 4 0 5 -2 -5
...
createNode renderLayer -n "defaultRenderLayer";
	setAttr ".g" yes;
createNode script -n "Zig_begin:Start:uiConfigurationScriptNode";
	...
	setAttr ".st" 3;
createNode script -n "Zig_begin:Start:sceneConfigurationScriptNode";
