...
//Name: N - Finish.ma
//Last modified: Sun, Feb 17, 2013 06:38:45 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -56.886501829894094 294.63141642264225 564.13838491980277 ;
	setAttr ".r" -type "double3" -27.338352730232387 354.19999999998953 5.9942262170956266e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 641.04247115288547;
...
createNode transform -n "transform5" -p "Start:pCube1";
	setAttr ".v" no;
createNode mesh -n "Start:pCubeShape1" -p "transform5";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode transform -n "transform4" -p "Start:pCube2";
	setAttr ".v" no;
createNode mesh -n "Start:pCubeShape2" -p "transform4";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "Start:pCube3" -p "group1";
	setAttr ".t" -type "double3" -1.4 0.5 0 ;
createNode transform -n "transform3" -p "Start:pCube3";
	setAttr ".v" no;
createNode mesh -n "Start:pCubeShape3" -p "transform3";
	setAttr -k off ".v";
	setAttr ".io" yes;
