...
//Name: A - Start.ma
//Last modified: Sun, Feb 17, 2013 05:25:16 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -27.887670723374001 166.69343173104835 390.9146500759577 ;
	setAttr ".r" -type "double3" -22.538352729608981 -4.2000000000008209 -2.1925194043022416e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 431.93110663771563;
...
createNode mesh -n "pCubeShape3" -p "transform2";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "pPrism1" -p "group1";
...
connectAttr "groupId7.id" "pPrismShape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "pPrismShape1.iog.og[0].gco";
connectAttr "groupId8.id" "pPrismShape1.ciog.cog[0].cgid";
...
connectAttr "pPrismShape1.o" "polyUnite1.ip[3]";
connectAttr "pCubeShape1.wm" "polyUnite1.im[0]";
connectAttr "pCubeShape2.wm" "polyUnite1.im[1]";
connectAttr "pCubeShape3.wm" "polyUnite1.im[2]";
connectAttr "pPrismShape1.wm" "polyUnite1.im[3]";
