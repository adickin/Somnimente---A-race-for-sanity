...
//Name: I - Drop.ma
//Last modified: Wed, Feb 27, 2013 10:56:38 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 233.44587217150385 90.554291805935407 233.44587217150024 ;
	setAttr ".r" -type "double3" -15.338352729602802 45.000000000000206 0 ;
	setAttr ".rp" -type "double3" 0 -3.5527136788005009e-15 -7.1054273576010019e-15 ;
	setAttr ".rpt" -type "double3" 3.5845739606089435e-16 2.7356490792467478e-15 1.4999272184619473e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 342.33613632262211;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.1413774815425386 -2.149206031608045 -8.4497026385447107 ;
	setAttr ".r" -type "double3" 0 89.999999999999972 0 ;
	setAttr ".rp" -type "double3" 8.8817841970012523e-16 2.2204460492503131e-16 0 ;
	setAttr ".rpt" -type "double3" -2.8459944852747933e-16 -6.7627397092441819e-16 -8.8817841970323117e-16 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 2.6413774815425386;
	setAttr ".ow" 24.037610497737983;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" 1.4999999999999996 -1.5 -5.0000000000000009 ;
	setAttr ".hc" -type "string" "viewSet -s %camera";
	setAttr ".o" yes;
createNode transform -n "group1";
	setAttr ".t" -type "double3" 1.5 -3.75 -5 ;
	setAttr ".s" -type "double3" 1 1 0.6999 ;
createNode transform -n "Start:pCube1" -p "group1";
	setAttr ".t" -type "double3" 0 4 3.5 ;
	setAttr ".s" -type "double3" 1 1 0.8 ;
createNode transform -n "transform6" -p "Start:pCube1";
	setAttr ".v" no;
createNode mesh -n "Start:pCubeShape1" -p "transform6";
	setAttr -k off ".v";
	setAttr ".io" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "Start:pCube2" -p "group1";
	setAttr ".t" -type "double3" 1.375 4.5 3.5 ;
	setAttr ".s" -type "double3" 1 1 0.8 ;
createNode transform -n "transform5" -p "Start:pCube2";
	setAttr ".v" no;
createNode mesh -n "Start:pCubeShape2" -p "transform5";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "Start:pCube3" -p "group1";
	setAttr ".t" -type "double3" -1.375 4.5 3.5 ;
	setAttr ".s" -type "double3" 1 1 0.8 ;
createNode transform -n "transform4" -p "Start:pCube3";
	setAttr ".v" no;
createNode mesh -n "Start:pCubeShape3" -p "transform4";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode transform -n "pCube2" -p "group1";
	setAttr ".t" -type "double3" 1.375 0.5 -3.5 ;
	setAttr ".s" -type "double3" 1 1 0.8 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "groupParts1.og" "Start:pCubeShape1.i";
connectAttr "groupId1.id" "Start:pCubeShape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Start:pCubeShape1.iog.og[0].gco";
connectAttr "groupId2.id" "Start:pCubeShape1.ciog.cog[0].cgid";
connectAttr "groupParts2.og" "Start:pCubeShape2.i";
connectAttr "groupId3.id" "Start:pCubeShape2.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Start:pCubeShape2.iog.og[0].gco";
connectAttr "groupId4.id" "Start:pCubeShape2.ciog.cog[0].cgid";
connectAttr "groupId5.id" "Start:pCubeShape3.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "Start:pCubeShape3.iog.og[0].gco";
connectAttr "groupId6.id" "Start:pCubeShape3.ciog.cog[0].cgid";
...
connectAttr "Start:pCubeShape1.o" "polyUnite1.ip[0]";
connectAttr "Start:pCubeShape2.o" "polyUnite1.ip[1]";
connectAttr "Start:pCubeShape3.o" "polyUnite1.ip[2]";
...
connectAttr "Start:pCubeShape1.wm" "polyUnite1.im[0]";
connectAttr "Start:pCubeShape2.wm" "polyUnite1.im[1]";
connectAttr "Start:pCubeShape3.wm" "polyUnite1.im[2]";
...
connectAttr "Start:polyCube1.out" "groupParts1.ig";
connectAttr "groupId1.id" "groupParts1.gi";
connectAttr "Start:polyCube2.out" "groupParts2.ig";
