...
//Name: I - Drop.ma
//Last modified: Sun, Feb 17, 2013 06:08:27 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -13.015339013665908 -105.23415115673646 -278.45622434371319 ;
	setAttr ".r" -type "double3" 20.661647270754347 -537.39999999995337 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 297.06445560341979;
