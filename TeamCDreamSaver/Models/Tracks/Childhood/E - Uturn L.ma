...
//Name: E - Uturn L.ma
//Last modified: Sun, Feb 17, 2013 05:39:27 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -174.47485571303358 186.86838910527413 369.80653814280151 ;
	setAttr ".r" -type "double3" -26.138352729616305 -7.3999999999992756 2.0045421822468748e-16 ;
	setAttr ".rp" -type "double3" 5.5511151231257827e-16 4.3715031594615539e-16 0 ;
	setAttr ".rpt" -type "double3" -2.7952390277144723e-16 -2.6725620705567269e-17 -5.048289104616104e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 419.9199026002575;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 2.9240220007223447 1.2055183582935212 1.8119761024281935 ;
...
createNode transform -n "pPipe1" -p "group1";
	setAttr ".t" -type "double3" 0 -0.5 1.5 ;
...
createNode transform -n "pPipe4";
	setAttr ".t" -type "double3" -5.5 0.25 0 ;
...
createNode deleteComponent -n "deleteComponent3";
	setAttr ".dc" -type "componentList" 8 "f[100:118]" "f[140:158]" "f[180:198]" "f[220:238]" "f[261:278]" "f[301:318]" "f[341:358]" "f[381:398]";
createNode deleteComponent -n "deleteComponent4";
	setAttr ".dc" -type "componentList" 8 "f[100]" "f[121]" "f[142]" "f[163]" "f[185]" "f[207]" "f[229]" "f[251]";
createNode deleteComponent -n "deleteComponent5";
	setAttr ".dc" -type "componentList" 1 "f[201]";
createNode deleteComponent -n "deleteComponent6";
	setAttr ".dc" -type "componentList" 3 "f[180]" "f[221]" "f[242]";
...
createNode deleteComponent -n "deleteComponent7";
	setAttr ".dc" -type "componentList" 4 "f[20:39]" "f[60:79]" "f[100:119]" "f[140:159]";
...
connectAttr "groupId11.id" "pPipeShape4.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "pPipeShape4.iog.og[0].gco";
connectAttr "groupParts8.og" "pPipeShape4.i";
connectAttr "groupId12.id" "pPipeShape4.ciog.cog[0].cgid";
