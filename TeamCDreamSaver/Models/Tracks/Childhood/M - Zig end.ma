...
//Name: M - Zig end.ma
//Last modified: Sun, Feb 17, 2013 06:28:34 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -503.72774860514232 160.0720050370121 -81.652243092613716 ;
	setAttr ".r" -type "double3" -17.399999999994542 -98.399999999998457 0 ;
	setAttr ".rpt" -type "double3" -3.4617278532882558e-16 -3.203716007064118e-16 6.6200490161069582e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 535.28484802830224;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -1.4715481455770166e-15 0 -6.7003977029719239 ;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.0661226373024952 5.6961524227066329 -9.6517410990397074 ;
	setAttr ".r" -type "double3" -89.999999999999972 89.999999999999972 0 ;
	setAttr ".rpt" -type "double3" -2.0129326546013888e-16 -2.8793757613560801e-17 7.9999370474594333e-27 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 5.196152422706632;
	setAttr ".ow" 15.84215439517771;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" 4.0661226373024935 0.50000000000000089 -9.6517410990397074 ;
	setAttr ".hc" -type "string" "viewSet -s %camera";
	setAttr ".o" yes;
createNode transform -n "group1";
	setAttr ".t" -type "double3" 1.5 0.25 0 ;
	setAttr ".s" -type "double3" 1 1 0.88587570877045285 ;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 1.5 -0.25 -4 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" 3 -0.25 -10 ;
...
createNode transform -n "pCube3";
	setAttr ".t" -type "double3" 0.125 0.25 -6 ;
...
createNode transform -n "pCube4";
	setAttr ".t" -type "double3" 2.875 0.25 -4 ;
...
createNode transform -n "pCube5";
	setAttr ".t" -type "double3" 4.375 0.25 -8.125 ;
...
createNode transform -n "pCube6";
	setAttr ".t" -type "double3" 3 0.25 -11.875 ;
...
createNode transform -n "polySurface8";
	setAttr ".t" -type "double3" -200 0 -90 ;
