...
//Name: Q - False Path R.ma
//Last modified: Sun, Mar 03, 2013 09:47:15 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -n "transform68" -p "sign:polySurface1";
	setAttr ".v" no;
createNode mesh -n "sign:polySurfaceShape1" -p "transform68";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
connectAttr "groupParts70.og" "sign:polySurfaceShape1.i";
connectAttr "groupId83.id" "sign:polySurfaceShape1.iog.og[0].gid";
connectAttr "lambert4SG.mwc" "sign:polySurfaceShape1.iog.og[0].gco";
connectAttr "groupId84.id" "sign:polySurfaceShape1.ciog.cog[0].cgid";
connectAttr "groupParts72.og" "polySurfaceShape60.i";
connectAttr "groupId85.id" "polySurfaceShape60.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "polySurfaceShape60.iog.og[0].gco";
connectAttr "groupId86.id" "polySurfaceShape60.iog.og[1].gid";
connectAttr "lambert4SG.mwc" "polySurfaceShape60.iog.og[1].gco";
...
connectAttr "polySurfaceShape60.iog.og[1]" "lambert4SG.dsm" -na;
connectAttr "groupId83.msg" "lambert4SG.gn" -na;
connectAttr "groupId84.msg" "lambert4SG.gn" -na;
...
connectAttr "polySurfaceShape59.o" "polyUnite10.ip[0]";
connectAttr "sign:polySurfaceShape1.o" "polyUnite10.ip[1]";
connectAttr "polySurfaceShape59.wm" "polyUnite10.im[0]";
connectAttr "sign:polySurfaceShape1.wm" "polyUnite10.im[1]";
connectAttr "polyTriangulate2.out" "groupParts70.ig";
connectAttr "groupId83.id" "groupParts70.gi";
connectAttr "polyUnite10.out" "groupParts71.ig";
connectAttr "groupId85.id" "groupParts71.gi";
connectAttr "groupParts71.og" "groupParts72.ig";
connectAttr "groupId86.id" "groupParts72.gi";
