...
//Last modified: Sun, Mar 03, 2013 09:46:16 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -n "transform83" -p "polySurface61";
	setAttr ".v" no;
...
createNode transform -n "transform82" -p "polySurface62";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape62" -p "transform82";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface63" -p "polySurface59";
createNode transform -n "transform81" -p "polySurface63";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape63" -p "transform81";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface64" -p "polySurface59";
...
createNode mesh -n "polySurfaceShape64" -p "transform80";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface65" -p "polySurface59";
...
createNode mesh -n "polySurfaceShape65" -p "transform79";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface66" -p "polySurface59";
...
createNode mesh -n "polySurfaceShape66" -p "transform78";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface67" -p "polySurface59";
...
createNode mesh -n "polySurfaceShape70" -p "transform74";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "transform68" -p "polySurface59";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape59" -p "transform68";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "polySurface71" -p "sign:polySurface1";
createNode transform -n "transform72" -p "polySurface71";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape71" -p "transform72";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface72" -p "sign:polySurface1";
createNode transform -n "transform71" -p "polySurface72";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape72" -p "transform71";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface73" -p "sign:polySurface1";
createNode transform -n "transform70" -p "polySurface73";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape73" -p "transform70";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "transform69" -p "sign:polySurface1";
	setAttr ".v" no;
createNode mesh -n "sign:polySurfaceShape1" -p "transform69";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "transform73" -p "polySurface74";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape74" -p "transform73";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode groupParts -n "groupParts87";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[209:268]";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "groupParts70.og" "polySurfaceShape60.i";
...
connectAttr "groupParts71.og" "polySurfaceShape61.i";
...
connectAttr "groupParts72.og" "polySurfaceShape62.i";
...
connectAttr "groupParts73.og" "polySurfaceShape63.i";
...
connectAttr "groupParts74.og" "polySurfaceShape64.i";
...
connectAttr "groupParts75.og" "polySurfaceShape65.i";
...
connectAttr "groupParts76.og" "polySurfaceShape66.i";
connectAttr "groupId89.id" "polySurfaceShape66.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "polySurfaceShape66.iog.og[0].gco";
connectAttr "groupParts77.og" "polySurfaceShape67.i";
...
connectAttr "groupParts78.og" "polySurfaceShape68.i";
...
connectAttr "groupParts79.og" "polySurfaceShape69.i";
...
connectAttr "groupParts80.og" "polySurfaceShape70.i";
...
connectAttr "groupParts82.og" "polySurfaceShape71.i";
connectAttr "groupId96.id" "polySurfaceShape71.iog.og[0].gid";
connectAttr "lambert4SG.mwc" "polySurfaceShape71.iog.og[0].gco";
connectAttr "groupParts83.og" "polySurfaceShape72.i";
connectAttr "groupId97.id" "polySurfaceShape72.iog.og[0].gid";
connectAttr "lambert4SG.mwc" "polySurfaceShape72.iog.og[0].gco";
connectAttr "groupParts84.og" "polySurfaceShape73.i";
connectAttr "groupId98.id" "polySurfaceShape73.iog.og[0].gid";
connectAttr "lambert4SG.mwc" "polySurfaceShape73.iog.og[0].gco";
connectAttr "groupParts81.og" "sign:polySurfaceShape1.i";
connectAttr "groupId94.id" "sign:polySurfaceShape1.iog.og[0].gid";
connectAttr "lambert4SG.mwc" "sign:polySurfaceShape1.iog.og[0].gco";
connectAttr "groupId95.id" "sign:polySurfaceShape1.ciog.cog[0].cgid";
connectAttr "groupParts85.og" "polySurfaceShape74.i";
connectAttr "groupId99.id" "polySurfaceShape74.iog.og[0].gid";
connectAttr "lambert4SG.mwc" "polySurfaceShape74.iog.og[0].gco";
connectAttr "groupParts87.og" "polySurfaceShape75.i";
connectAttr "groupId100.id" "polySurfaceShape75.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "polySurfaceShape75.iog.og[0].gco";
connectAttr "groupId101.id" "polySurfaceShape75.iog.og[1].gid";
connectAttr "lambert4SG.mwc" "polySurfaceShape75.iog.og[1].gco";
...
connectAttr "sign:polySurfaceShape1.iog.og[0]" "lambert4SG.dsm" -na;
connectAttr "sign:polySurfaceShape1.ciog.cog[0]" "lambert4SG.dsm" -na;
connectAttr "polySurfaceShape71.iog.og[0]" "lambert4SG.dsm" -na;
connectAttr "polySurfaceShape72.iog.og[0]" "lambert4SG.dsm" -na;
connectAttr "polySurfaceShape73.iog.og[0]" "lambert4SG.dsm" -na;
connectAttr "polySurfaceShape74.iog.og[0]" "lambert4SG.dsm" -na;
connectAttr "polySurfaceShape75.iog.og[1]" "lambert4SG.dsm" -na;
...
connectAttr "polySurfaceShape59.o" "polySeparate9.ip";
connectAttr "polySeparate9.out[0]" "groupParts70.ig";
connectAttr "groupId83.id" "groupParts70.gi";
connectAttr "polySeparate9.out[1]" "groupParts71.ig";
connectAttr "groupId84.id" "groupParts71.gi";
connectAttr "polySeparate9.out[2]" "groupParts72.ig";
connectAttr "groupId85.id" "groupParts72.gi";
connectAttr "polySeparate9.out[3]" "groupParts73.ig";
connectAttr "groupId86.id" "groupParts73.gi";
connectAttr "polySeparate9.out[4]" "groupParts74.ig";
connectAttr "groupId87.id" "groupParts74.gi";
connectAttr "polySeparate9.out[5]" "groupParts75.ig";
connectAttr "groupId88.id" "groupParts75.gi";
connectAttr "polySeparate9.out[6]" "groupParts76.ig";
connectAttr "groupId89.id" "groupParts76.gi";
connectAttr "polySeparate9.out[7]" "groupParts77.ig";
connectAttr "groupId90.id" "groupParts77.gi";
connectAttr "polySeparate9.out[8]" "groupParts78.ig";
connectAttr "groupId91.id" "groupParts78.gi";
connectAttr "polySeparate9.out[9]" "groupParts79.ig";
connectAttr "groupId92.id" "groupParts79.gi";
connectAttr "polySeparate9.out[10]" "groupParts80.ig";
connectAttr "groupId93.id" "groupParts80.gi";
connectAttr "sign:polySurfaceShape1.o" "polySeparate10.ip";
connectAttr "polyTriangulate2.out" "groupParts81.ig";
connectAttr "groupId94.id" "groupParts81.gi";
connectAttr "polySeparate10.out[0]" "groupParts82.ig";
connectAttr "groupId96.id" "groupParts82.gi";
connectAttr "polySeparate10.out[1]" "groupParts83.ig";
connectAttr "groupId97.id" "groupParts83.gi";
connectAttr "polySeparate10.out[2]" "groupParts84.ig";
connectAttr "groupId98.id" "groupParts84.gi";
connectAttr "polySurfaceShape71.o" "polyUnite10.ip[0]";
connectAttr "polySurfaceShape72.o" "polyUnite10.ip[1]";
connectAttr "polySurfaceShape73.o" "polyUnite10.ip[2]";
connectAttr "polySurfaceShape71.wm" "polyUnite10.im[0]";
connectAttr "polySurfaceShape72.wm" "polyUnite10.im[1]";
connectAttr "polySurfaceShape73.wm" "polyUnite10.im[2]";
connectAttr "polyUnite10.out" "groupParts85.ig";
connectAttr "groupId99.id" "groupParts85.gi";
connectAttr "polySurfaceShape60.o" "polyUnite11.ip[0]";
connectAttr "polySurfaceShape61.o" "polyUnite11.ip[1]";
connectAttr "polySurfaceShape62.o" "polyUnite11.ip[2]";
connectAttr "polySurfaceShape63.o" "polyUnite11.ip[3]";
connectAttr "polySurfaceShape64.o" "polyUnite11.ip[4]";
connectAttr "polySurfaceShape65.o" "polyUnite11.ip[5]";
connectAttr "polySurfaceShape66.o" "polyUnite11.ip[6]";
connectAttr "polySurfaceShape67.o" "polyUnite11.ip[7]";
connectAttr "polySurfaceShape68.o" "polyUnite11.ip[8]";
connectAttr "polySurfaceShape69.o" "polyUnite11.ip[9]";
connectAttr "polySurfaceShape70.o" "polyUnite11.ip[10]";
connectAttr "polySurfaceShape74.o" "polyUnite11.ip[11]";
connectAttr "polySurfaceShape60.wm" "polyUnite11.im[0]";
connectAttr "polySurfaceShape61.wm" "polyUnite11.im[1]";
connectAttr "polySurfaceShape62.wm" "polyUnite11.im[2]";
connectAttr "polySurfaceShape63.wm" "polyUnite11.im[3]";
connectAttr "polySurfaceShape64.wm" "polyUnite11.im[4]";
connectAttr "polySurfaceShape65.wm" "polyUnite11.im[5]";
connectAttr "polySurfaceShape66.wm" "polyUnite11.im[6]";
connectAttr "polySurfaceShape67.wm" "polyUnite11.im[7]";
connectAttr "polySurfaceShape68.wm" "polyUnite11.im[8]";
connectAttr "polySurfaceShape69.wm" "polyUnite11.im[9]";
connectAttr "polySurfaceShape70.wm" "polyUnite11.im[10]";
connectAttr "polySurfaceShape74.wm" "polyUnite11.im[11]";
connectAttr "polyUnite11.out" "groupParts86.ig";
