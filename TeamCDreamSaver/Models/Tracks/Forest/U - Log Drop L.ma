...
//Name: U - Log Drop L.ma
//Last modified: Thu, Feb 28, 2013 02:01:32 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -181.21742291131216 -15.578547725711395 -313.93855226896551 ;
	setAttr ".r" -type "double3" 2.4000000000061608 211.19999999996261 0 ;
	setAttr ".rp" -type "double3" 0 -1.7763568394002505e-15 -8.8817841970012523e-16 ;
	setAttr ".rpt" -type "double3" 8.0229923678431566e-18 9.3915845147774547e-16 2.6539623685273551e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 357.42406407343742;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 3.2844232394409449e-21 -2.0000000000000018 -12.000000000000002 ;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.3206712876522566 5.3774155188211328 -10.462335328892101 ;
	setAttr ".r" -type "double3" -89.999999999999986 89.999999999999986 0 ;
	setAttr ".rpt" -type "double3" 3.4611778030296814e-17 1.9568512378582387e-17 6.8433683527922785e-29 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 6.5024155188211337;
	setAttr ".ow" 38.805795560900094;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" 1.8404801871111292 -1.125 -8.1313257217407227 ;
	setAttr ".hc" -type "string" "viewSet -s %camera";
	setAttr ".o" yes;
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0 -0.25 -4 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" 1.1019815388648255 -2 -12 ;
	setAttr ".r" -type "double3" 0 -24.34751741452331 0 ;
...
createNode mesh -n "pCubeShape2" -p "transform1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 12 ".vt[0:11]"  -1.5 -0.25 4 0 -0.25 4 1.5 -0.25 4 -1.5 0.25 4
		 0 0.25 4 1.5 0.25 4 -1.5 0.25 -4 0 0.25 -4 1.5 0.25 -4 -1.5 -0.25 -4 0 -0.25 -4 1.5 -0.25 -4;
...
createNode transform -n "pCube3";
	setAttr ".t" -type "double3" 1.839137230374418 -2.0000000000000009 -11.494607689840072 ;
...
createNode transform -n "polySurface5" -p "polySurface3";
	setAttr ".t" -type "double3" 0.82761175366848638 0 -0.09195686151871918 ;
...
createNode transform -n "polySurface8" -p "polySurface6";
	setAttr ".t" -type "double3" 8.0002469521286947 -2.6645352591003757e-15 -5.5174116911232343 ;
