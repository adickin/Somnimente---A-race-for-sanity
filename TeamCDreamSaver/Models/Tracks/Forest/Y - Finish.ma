...
//Name: Y - Finish.ma
//Last modified: Sun, Mar 03, 2013 09:52:11 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -69.091668853120581 90.258618771079227 220.47178342038563 ;
	setAttr ".r" -type "double3" -21.338352729602914 -17.399999999998691 4.1663438790216186e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 248.04855220689339;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "N___Finish:group1";
	setAttr ".t" -type "double3" 1.5 0.25 -4.5 ;
createNode transform -n "N___Finish:Start:pCube1" -p "N___Finish:group1";
createNode transform -n "transform5" -p "N___Finish:Start:pCube1";
	setAttr ".v" no;
createNode mesh -n "N___Finish:Start:pCubeShape1" -p "transform5";
	setAttr -k off ".v";
	setAttr ".io" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "N___Finish:Start:pCube2" -p "N___Finish:group1";
	setAttr ".t" -type "double3" 1.4 0.5 0 ;
createNode transform -n "transform4" -p "N___Finish:Start:pCube2";
	setAttr ".v" no;
createNode mesh -n "N___Finish:Start:pCubeShape2" -p "transform4";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "N___Finish:Start:pCube3" -p "N___Finish:group1";
	setAttr ".t" -type "double3" -1.4 0.5 0 ;
createNode transform -n "transform3" -p "N___Finish:Start:pCube3";
	setAttr ".v" no;
createNode mesh -n "N___Finish:Start:pCubeShape3" -p "transform3";
	setAttr -k off ".v";
	setAttr ".io" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "N___Finish:pCylinder1" -p "N___Finish:group1";
	setAttr ".t" -type "double3" 0 0 -6.8359612562270247 ;
createNode transform -n "transform2" -p "N___Finish:pCylinder1";
	setAttr ".v" no;
createNode mesh -n "N___Finish:pCylinderShape1" -p "transform2";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "N___Finish:pPipe1" -p "N___Finish:group1";
	setAttr ".t" -type "double3" 0 0.5 -6.8359612562270247 ;
createNode transform -n "transform1" -p "N___Finish:pPipe1";
	setAttr ".v" no;
createNode mesh -n "N___Finish:pPipeShape1" -p "transform1";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode renderLayer -n "defaultRenderLayer";
	setAttr ".g" yes;
createNode polyCube -n "N___Finish:Start:polyCube1";
	setAttr ".w" 3;
	setAttr ".h" 0.5;
	setAttr ".d" 9;
	setAttr ".cuv" 4;
createNode polyCube -n "N___Finish:Start:polyCube2";
	setAttr ".w" 0.25;
	setAttr ".h" 0.5;
	setAttr ".d" 9;
	setAttr ".cuv" 4;
createNode script -n "N___Finish:Start:uiConfigurationScriptNode";
	...
	setAttr ".st" 3;
createNode script -n "N___Finish:Start:sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 24 -ast 1 -aet 48 ";
	setAttr ".st" 6;
createNode polyCylinder -n "N___Finish:polyCylinder1";
	setAttr ".r" 3;
	setAttr ".h" 0.5;
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
createNode polyPipe -n "N___Finish:polyPipe1";
	setAttr ".r" 3;
	setAttr ".h" 0.5;
	setAttr ".t" 0.25;
	setAttr ".sc" 0;
createNode deleteComponent -n "N___Finish:deleteComponent1";
	setAttr ".dc" -type "componentList" 1 "f[33:36]";
createNode deleteComponent -n "N___Finish:deleteComponent2";
	setAttr ".dc" -type "componentList" 3 "f[13:16]" "f[49:52]" "f[69:72]";
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "groupParts1.og" "N___Finish:Start:pCubeShape1.i";
connectAttr "groupId1.id" "N___Finish:Start:pCubeShape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "N___Finish:Start:pCubeShape1.iog.og[0].gco"
		;
connectAttr "groupId2.id" "N___Finish:Start:pCubeShape1.ciog.cog[0].cgid";
connectAttr "groupParts2.og" "N___Finish:Start:pCubeShape2.i";
connectAttr "groupId3.id" "N___Finish:Start:pCubeShape2.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "N___Finish:Start:pCubeShape2.iog.og[0].gco"
		;
connectAttr "groupId4.id" "N___Finish:Start:pCubeShape2.ciog.cog[0].cgid";
connectAttr "groupId5.id" "N___Finish:Start:pCubeShape3.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "N___Finish:Start:pCubeShape3.iog.og[0].gco"
		;
connectAttr "groupId6.id" "N___Finish:Start:pCubeShape3.ciog.cog[0].cgid";
connectAttr "groupParts3.og" "N___Finish:pCylinderShape1.i";
connectAttr "groupId7.id" "N___Finish:pCylinderShape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "N___Finish:pCylinderShape1.iog.og[0].gco"
		;
connectAttr "groupId8.id" "N___Finish:pCylinderShape1.ciog.cog[0].cgid";
connectAttr "groupParts4.og" "N___Finish:pPipeShape1.i";
connectAttr "groupId9.id" "N___Finish:pPipeShape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "N___Finish:pPipeShape1.iog.og[0].gco";
connectAttr "groupId10.id" "N___Finish:pPipeShape1.ciog.cog[0].cgid";
...
connectAttr "N___Finish:polyPipe1.out" "N___Finish:deleteComponent1.ig";
connectAttr "N___Finish:deleteComponent1.og" "N___Finish:deleteComponent2.ig";
connectAttr "N___Finish:Start:pCubeShape1.o" "polyUnite1.ip[0]";
connectAttr "N___Finish:Start:pCubeShape2.o" "polyUnite1.ip[1]";
connectAttr "N___Finish:Start:pCubeShape3.o" "polyUnite1.ip[2]";
connectAttr "N___Finish:pCylinderShape1.o" "polyUnite1.ip[3]";
connectAttr "N___Finish:pPipeShape1.o" "polyUnite1.ip[4]";
connectAttr "N___Finish:Start:pCubeShape1.wm" "polyUnite1.im[0]";
connectAttr "N___Finish:Start:pCubeShape2.wm" "polyUnite1.im[1]";
connectAttr "N___Finish:Start:pCubeShape3.wm" "polyUnite1.im[2]";
connectAttr "N___Finish:pCylinderShape1.wm" "polyUnite1.im[3]";
connectAttr "N___Finish:pPipeShape1.wm" "polyUnite1.im[4]";
connectAttr "N___Finish:Start:polyCube1.out" "groupParts1.ig";
connectAttr "groupId1.id" "groupParts1.gi";
connectAttr "N___Finish:Start:polyCube2.out" "groupParts2.ig";
connectAttr "groupId3.id" "groupParts2.gi";
connectAttr "N___Finish:polyCylinder1.out" "groupParts3.ig";
connectAttr "groupId7.id" "groupParts3.gi";
connectAttr "N___Finish:deleteComponent2.og" "groupParts4.ig";
...
connectAttr "polySeparate2.out[4]" "groupParts16.ig";
...
connectAttr "polySurfaceShape11.o" "polyUnite3.ip[3]";
connectAttr "polySurfaceShape12.o" "polyUnite3.ip[4]";
...
connectAttr "polySurfaceShape11.wm" "polyUnite3.im[3]";
connectAttr "polySurfaceShape12.wm" "polyUnite3.im[4]";
...
connectAttr "N___Finish:Start:pCubeShape1.ciog.cog[0]" ":initialShadingGroup.dsm"
		 -na;
connectAttr "N___Finish:Start:pCubeShape2.iog.og[0]" ":initialShadingGroup.dsm" 
		-na;
connectAttr "N___Finish:Start:pCubeShape2.ciog.cog[0]" ":initialShadingGroup.dsm"
		 -na;
connectAttr "N___Finish:Start:pCubeShape3.iog.og[0]" ":initialShadingGroup.dsm" 
		-na;
connectAttr "N___Finish:Start:pCubeShape3.ciog.cog[0]" ":initialShadingGroup.dsm"
		 -na;
connectAttr "N___Finish:pCylinderShape1.iog.og[0]" ":initialShadingGroup.dsm" -na
		;
connectAttr "N___Finish:pCylinderShape1.ciog.cog[0]" ":initialShadingGroup.dsm" 
		-na;
connectAttr "N___Finish:pPipeShape1.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "N___Finish:pPipeShape1.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
