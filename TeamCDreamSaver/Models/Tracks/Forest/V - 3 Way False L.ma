...
//Last modified: Sun, Mar 03, 2013 09:49:52 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -n "transform77" -p "polySurface70";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape70" -p "transform77";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "transform76" -p "sign:polySurface1";
	setAttr ".v" no;
createNode mesh -n "sign:polySurfaceShape1" -p "transform76";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
connectAttr "groupParts76.og" "sign:polySurfaceShape1.i";
connectAttr "groupId91.id" "sign:polySurfaceShape1.iog.og[0].gid";
connectAttr "lambert2SG.mwc" "sign:polySurfaceShape1.iog.og[0].gco";
connectAttr "groupId92.id" "sign:polySurfaceShape1.ciog.cog[0].cgid";
connectAttr "groupParts78.og" "polySurfaceShape71.i";
connectAttr "groupId93.id" "polySurfaceShape71.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "polySurfaceShape71.iog.og[0].gco";
connectAttr "groupId94.id" "polySurfaceShape71.iog.og[1].gid";
connectAttr "lambert2SG.mwc" "polySurfaceShape71.iog.og[1].gco";
...
connectAttr "sign:polySurfaceShape1.iog.og[0]" "lambert2SG.dsm" -na;
connectAttr "sign:polySurfaceShape1.ciog.cog[0]" "lambert2SG.dsm" -na;
connectAttr "polySurfaceShape71.iog.og[1]" "lambert2SG.dsm" -na;
...
connectAttr "polySurfaceShape70.o" "polyUnite13.ip[0]";
connectAttr "sign:polySurfaceShape1.o" "polyUnite13.ip[1]";
connectAttr "polySurfaceShape70.wm" "polyUnite13.im[0]";
connectAttr "sign:polySurfaceShape1.wm" "polyUnite13.im[1]";
connectAttr "polyTriangulate2.out" "groupParts76.ig";
connectAttr "groupId91.id" "groupParts76.gi";
connectAttr "polyUnite13.out" "groupParts77.ig";
connectAttr "groupId93.id" "groupParts77.gi";
connectAttr "groupParts77.og" "groupParts78.ig";
connectAttr "groupId94.id" "groupParts78.gi";
