...
//Last modified: Sun, Mar 03, 2013 09:50:23 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -n "transform77" -p "sign:polySurface1";
	setAttr ".v" no;
createNode mesh -n "sign:polySurfaceShape1" -p "transform77";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode mesh -n "polySurfaceShape72" -p "polySurface71";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "transform76" -p "polySurface71";
	setAttr ".v" no;
createNode mesh -n "polySurfaceShape71" -p "transform76";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
connectAttr "groupParts77.og" "polySurfaceShape71.i";
connectAttr "groupId93.id" "polySurfaceShape71.iog.og[0].gid";
connectAttr "lambert2SG.mwc" "polySurfaceShape71.iog.og[0].gco";
connectAttr "groupId94.id" "polySurfaceShape71.ciog.cog[0].cgid";
connectAttr "groupParts79.og" "polySurfaceShape73.i";
connectAttr "groupId95.id" "polySurfaceShape73.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "polySurfaceShape73.iog.og[0].gco";
connectAttr "groupId96.id" "polySurfaceShape73.iog.og[1].gid";
connectAttr "lambert2SG.mwc" "polySurfaceShape73.iog.og[1].gco";
...
connectAttr "polySurfaceShape73.iog.og[1]" "lambert2SG.dsm" -na;
