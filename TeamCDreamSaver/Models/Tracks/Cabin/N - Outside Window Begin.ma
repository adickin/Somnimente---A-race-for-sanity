...
//Name: N - Outside Window Begin.ma
//Last modified: Sun, Mar 03, 2013 09:57:56 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 339.58618112673798 91.929262771222113 -147.02847394874271 ;
	setAttr ".r" -type "double3" -14.138352729590986 -246.60000000001114 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 380.07462646573856;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.99999904632568 16.088458919932265 -3.0000008344650269 ;
	setAttr ".r" -type "double3" -89.999999999999986 89.999999999999986 0 ;
	setAttr ".rpt" -type "double3" -8.7827310353823177e-17 1.3677701410493199e-16 1.2394779758058848e-26 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 15.588458919932265;
	setAttr ".ow" 863.39342791145714;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" 8.9999990463256765 0.5 -3.0000008344650269 ;
...
connectAttr "polyCube3.out" "polyTriangulate2.ip";
...
connectAttr "polyTriangulate2.out" "groupParts15.ig";
connectAttr "groupId22.id" "groupParts15.gi";
connectAttr "polyTriangulate3.out" "groupParts16.ig";
...
// End of N - Outside Window Begin.ma
