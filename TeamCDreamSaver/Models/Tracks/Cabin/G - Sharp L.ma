...
//Name: G - Sharp L.ma
//Last modified: Sun, Mar 03, 2013 09:55:00 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	...
	setAttr ".r" -type "double3" -79.538352729424801 -7.3999999999777923 -8.0181687289871086e-16 ;
...
createNode transform -n "polySurface2" -p "E___Sharp_R:polySurface8";
...
createNode mesh -n "polySurfaceShape2" -p "transform14";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface3" -p "E___Sharp_R:polySurface8";
...
createNode mesh -n "polySurfaceShape3" -p "transform13";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface4" -p "E___Sharp_R:polySurface8";
...
createNode mesh -n "polySurfaceShape4" -p "transform12";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface5" -p "E___Sharp_R:polySurface8";
...
createNode mesh -n "polySurfaceShape5" -p "transform11";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface6" -p "E___Sharp_R:polySurface8";
...
createNode mesh -n "polySurfaceShape6" -p "transform10";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "polySurface7" -p "E___Sharp_R:polySurface8";
...
createNode mesh -n "polySurfaceShape7" -p "transform9";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "transform8" -p "E___Sharp_R:polySurface8";
	setAttr ".v" no;
createNode mesh -n "E___Sharp_R:polySurfaceShape8" -p "transform8";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
connectAttr "polyTriangulate1.out" "E___Sharp_R:polySurfaceShape8.i";
...
connectAttr "E___Sharp_R:groupParts11.og" "polyTriangulate1.ip";
connectAttr "E___Sharp_R:polySurfaceShape8.o" "polySeparate1.ip";
