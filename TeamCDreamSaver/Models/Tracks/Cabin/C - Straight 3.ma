...
//Name: C - Straight 3.ma
//Last modified: Sun, Mar 03, 2013 09:53:07 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.39666570263469064 3.0517983958607289 113.63589164550392 ;
	setAttr ".r" -type "double3" -1.5383527295364521 -0.20000000000908985 -3.1060293541104555e-18 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 113.67755577596292;
...
createNode transform -n "A___Start:pCube1" -p "A___Start:group1";
	...
	setAttr ".s" -type "double3" 1 1 0.33 ;
createNode transform -n "transform3" -p "A___Start:pCube1";
	setAttr ".v" no;
createNode mesh -n "A___Start:pCubeShape1" -p "transform3";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode transform -n "A___Start:pCube2" -p "A___Start:group1";
	setAttr ".t" -type "double3" 1.375 0.5 3 ;
	setAttr ".s" -type "double3" 1 1 0.33 ;
createNode transform -n "transform2" -p "A___Start:pCube2";
	setAttr ".v" no;
createNode mesh -n "A___Start:pCubeShape2" -p "transform2";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "A___Start:pCube3" -p "A___Start:group1";
	setAttr ".t" -type "double3" -1.375 0.5 3 ;
	setAttr ".s" -type "double3" 1 1 0.33 ;
createNode transform -n "transform1" -p "A___Start:pCube3";
	setAttr ".v" no;
createNode mesh -n "A___Start:pCubeShape3" -p "transform1";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
connectAttr "groupId1.id" "A___Start:pCubeShape1.iog.og[1].gid";
connectAttr ":initialShadingGroup.mwc" "A___Start:pCubeShape1.iog.og[1].gco";
connectAttr "groupId2.id" "A___Start:pCubeShape1.ciog.cog[1].cgid";
connectAttr "groupParts2.og" "A___Start:pCubeShape2.i";
connectAttr "groupId3.id" "A___Start:pCubeShape2.iog.og[1].gid";
connectAttr ":initialShadingGroup.mwc" "A___Start:pCubeShape2.iog.og[1].gco";
connectAttr "groupId4.id" "A___Start:pCubeShape2.ciog.cog[1].cgid";
connectAttr "groupId5.id" "A___Start:pCubeShape3.iog.og[1].gid";
connectAttr ":initialShadingGroup.mwc" "A___Start:pCubeShape3.iog.og[1].gco";
connectAttr "groupId6.id" "A___Start:pCubeShape3.ciog.cog[1].cgid";
...
connectAttr "A___Start:pCubeShape1.iog.og[1]" ":initialShadingGroup.dsm" -na;
connectAttr "A___Start:pCubeShape1.ciog.cog[1]" ":initialShadingGroup.dsm" -na;
connectAttr "A___Start:pCubeShape2.iog.og[1]" ":initialShadingGroup.dsm" -na;
connectAttr "A___Start:pCubeShape2.ciog.cog[1]" ":initialShadingGroup.dsm" -na;
connectAttr "A___Start:pCubeShape3.iog.og[1]" ":initialShadingGroup.dsm" -na;
connectAttr "A___Start:pCubeShape3.ciog.cog[1]" ":initialShadingGroup.dsm" -na;
