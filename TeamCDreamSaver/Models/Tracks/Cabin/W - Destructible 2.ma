...
//Last modified: Wed, Mar 06, 2013 09:20:21 AM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 15.007499694824217 6149.2539344260058 4.5000000000013491 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
	setAttr ".rp" -type "double3" 0 0 1.4210854715202004e-14 ;
	setAttr ".rpt" -type "double3" 2.5860797428679169e-15 1.4571132286412864e-14 -1.5245728857016134e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 6149.2539344260658;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 15.007499694824219 -1.4210854715202004e-14 4.4999999999999822 ;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 30.469141360661659 28.565848472409662 -1.7043530251449583 ;
	setAttr ".r" -type "double3" -89.999999999999972 89.999999999999972 0 ;
	setAttr ".rpt" -type "double3" 1.2412441683929859e-15 -1.9800707705317815e-15 8.3039469927793442e-27 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 28.565848472409666;
	setAttr ".ow" 13.853105696355424;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" 15.007499694824203 0 4.5000000000000018 ;
...
createNode transform -n "pCube7";
	setAttr ".t" -type "double3" 15 0.25 0.125 ;
...
connectAttr "polyCube5.out" "polyTriangulate2.ip";
