...
//Last modified: Sun, Mar 03, 2013 10:01:57 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -293.76944518121672 190.20637590955224 851.90930846989522 ;
	setAttr ".r" -type "double3" -11.738352729618411 -18.599999999999969 -8.3895882366224587e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 920.59744582564588;
...
createNode transform -n "pCube1" -p "group1";
	setAttr ".t" -type "double3" 16.5 0.25 -4.5 ;
	setAttr ".s" -type "double3" 1.57 1 1 ;
...
createNode transform -n "pCube2" -p "group1";
	setAttr ".t" -type "double3" 16.5 0.75 -8.875 ;
	setAttr ".s" -type "double3" 1.57 1 1 ;
...
createNode transform -n "pCube5" -p "group1";
	setAttr ".t" -type "double3" 32.85 0.75 -4.5 ;
...
createNode transform -n "pCube6" -p "group1";
	setAttr ".t" -type "double3" 16.625 0.75 -0.125 ;
