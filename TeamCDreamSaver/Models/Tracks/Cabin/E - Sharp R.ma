...
//Name: E - Sharp R.ma
//Last modified: Sun, Mar 03, 2013 09:54:04 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 146.15707531391007 30.929272073734289 -97.657248770530146 ;
	setAttr ".r" -type "double3" -9.9383527294225988 123.79999999999956 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 173.84507155212765;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.2265055483167906 0.75000000000000111 -5.8749999999999991 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
	setAttr ".rp" -type "double3" 8.8817841970012523e-16 -1.1102230246251563e-16 0 ;
	setAttr ".rpt" -type "double3" -4.3984372556300765e-16 -1.0608173746113083e-15 -9.7572672577975487e-16 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 5.2351871361443783;
	setAttr ".ow" 14.406766904084421;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" 2.9913184121724123 0.75 -5.875 ;
...
createNode mesh -n "D___Straight_6:A___Start:pCubeShape3" -p "transform4";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "D___Straight_6:A___Start:pCube4" -p "D___Straight_6:A___Start:group1";
...
createNode mesh -n "D___Straight_6:A___Start:pCubeShape4" -p "transform3";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "D___Straight_6:A___Start:pCube5" -p "D___Straight_6:A___Start:group1";
...
createNode mesh -n "D___Straight_6:A___Start:pCubeShape5" -p "transform2";
	...
	setAttr ".db" yes;
	setAttr ".bw" 4;
createNode transform -n "D___Straight_6:A___Start:pCube6";
...
connectAttr "polySeparate2.out[5]" "groupParts17.ig";
...
connectAttr "polySurfaceShape14.o" "polyUnite3.ip[5]";
...
connectAttr "polySurfaceShape14.wm" "polyUnite3.im[5]";
