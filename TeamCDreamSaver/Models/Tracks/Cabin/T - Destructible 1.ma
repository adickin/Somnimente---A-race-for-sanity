...
//Last modified: Sun, Mar 03, 2013 10:00:37 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 486.40596632028399 48.386550390734257 116.78209531625089 ;
	setAttr ".r" -type "double3" -11.400000000000013 47.200000000000706 -1.1702830919738162e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 163.75526724476788;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 10.5 0.49999999999942091 -4.5000000000000098 ;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 10.5 0.25 -4.5 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" 10.5 0.75 -8.875 ;
...
createNode transform -n "pCube3";
	setAttr ".t" -type "double3" 10.5 0.75 -0.125 ;
	setAttr ".s" -type "double3" 0.715 1 1 ;
...
createNode mesh -n "pCubeShape3" -p "transform3";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".vt[0:7]"  -10.5 -0.25 0.125 10.5 -0.25 0.125 -10.5 0.25 0.125
		 10.5 0.25 0.125 -10.5 0.25 -0.125 10.5 0.25 -0.125 -10.5 -0.25 -0.125 10.5 -0.25 -0.125;
...
createNode transform -n "pCube4";
	setAttr ".t" -type "double3" 0.125 0.75 -4.5 ;
...
createNode transform -n "pCube5";
	setAttr ".t" -type "double3" 20.875 0.75 -4.5 ;
