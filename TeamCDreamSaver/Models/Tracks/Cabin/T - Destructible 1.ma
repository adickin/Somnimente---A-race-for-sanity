...
//Last modified: Wed, Mar 06, 2013 09:16:58 AM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.9999999999991775 1888.8196822835321 4.5 ;
	...
	setAttr ".rpt" -type "double3" 6.924653897278285e-15 2.4000709118313652e-15 -6.9701297893263731e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 50.889764667547865;
	setAttr ".coi" 1888.8196822835321;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -9.0000000000000089 3.5527136788005009e-15 4.4999999999999991 ;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -9.6624004150600076 18.186533479473209 -1.9522707096584049 ;
	setAttr ".r" -type "double3" -89.999999999999986 89.999999999999986 0 ;
	setAttr ".rpt" -type "double3" 8.9946832136789103e-17 -6.716596682755553e-16 1.0531884730379423e-26 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 18.186533479473212;
	setAttr ".ow" 27.883924519912163;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" -9.0000000000000071 3.5527136788005009e-15 4.4999999999999991 ;
...
createNode transform -n "pCube6";
	setAttr ".t" -type "double3" -9 0.25 0.125 ;
...
connectAttr "groupId27.id" "polySurfaceShape17.iog.og[0].gid";
...
connectAttr "polySeparate3.out[4]" "groupParts21.ig";
connectAttr "groupId28.id" "groupParts21.gi";
connectAttr "polyCube4.out" "polyTriangulate2.ip";
...
connectAttr "polyTriangulate2.out" "groupParts22.ig";
