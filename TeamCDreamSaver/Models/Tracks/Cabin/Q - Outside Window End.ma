...
//Name: Q - Outside Window End.ma
//Last modified: Thu, Feb 28, 2013 02:36:17 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.9035233945127388 374.86810148271536 240.11593565972981 ;
	setAttr ".r" -type "double3" -57.33835272960274 1.7999999999987566 -3.9776560849932185e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 446.3592495538424;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.4223718785253068 16.088458919932265 -6.9816313055802581 ;
...
createNode transform -n "group2";
	setAttr ".t" -type "double3" 6 0 -18 ;
	setAttr ".r" -type "double3" 0 -90 0 ;
	setAttr ".s" -type "double3" 1 1 -1 ;
createNode transform -n "polySurface1" -p "group2";
	setAttr ".t" -type "double3" 9 0 -6.2332075621955194e-16 ;
...
createNode transform -n "pCube1" -p "group2";
	setAttr ".t" -type "double3" 13.5 0.25 -4.5 ;
...
createNode transform -n "pCube2" -p "group2";
	setAttr ".t" -type "double3" 13.5 0.75 -3.125 ;
	setAttr ".s" -type "double3" 0.75 1 1 ;
...
createNode transform -n "pCube3" -p "group2";
	setAttr ".t" -type "double3" 13.5 0.75 -5.875 ;
	setAttr ".s" -type "double3" 0.75 1 1 ;
...
createNode transform -n "pCube4";
	setAttr ".t" -type "double3" 0 5 -100 ;
...
// End of Q - Outside Window End.ma
