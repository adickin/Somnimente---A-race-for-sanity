...
createNode transform -n "transform5" -p "A___Start:pCube1";
	setAttr ".v" no;
createNode mesh -n "A___Start:pCubeShape1" -p "transform5";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode transform -n "A___Start:pCube2" -p "A___Start:group1";
	...
	setAttr ".s" -type "double3" 1 1 1.333 ;
createNode transform -n "transform4" -p "A___Start:pCube2";
	setAttr ".v" no;
createNode mesh -n "A___Start:pCubeShape2" -p "transform4";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "A___Start:pCube3" -p "A___Start:group1";
	setAttr ".t" -type "double3" -1.375 0.5 -1.5 ;
	setAttr ".s" -type "double3" 1 1 1.333 ;
createNode transform -n "transform3" -p "A___Start:pCube3";
	setAttr ".v" no;
createNode mesh -n "A___Start:pCubeShape3" -p "transform3";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode mesh -n "pCubeShape2" -p "transform1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".vt[0:7]"  -12.5 -12.5 6 12.5 -12.5 6 -12.5 12.5 6 12.5 12.5 6
		 -12.5 12.5 -6 12.5 12.5 -6 -12.5 -12.5 -6 12.5 -12.5 -6;
	setAttr -s 12 ".ed[0:11]"  0 1 0 2 3 0 4 5 0 6 7 0 0 2 0 1 3 0 2 4 0
		 3 5 0 4 6 0 5 7 0 6 0 0 7 1 0;
	setAttr -s 6 -ch 24 ".fc[0:5]" -type "polyFaces" 
		f 4 0 5 -2 -5
